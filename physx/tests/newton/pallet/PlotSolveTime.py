"""Plot per-step time of the five-pallet conveyor for PhysX Newton and MuJoCo.
...
`solve_ms` column, the constraint-solver stage of each engine: Newton island preparation,
...
SERIES = [
    ('physx-new', 'PhysX Newton (current)', COLORS[0]),
    ('mujoco', 'MuJoCo 3.13 Newton', COLORS[1]),
    ('physx-before', 'PhysX Newton (before)', COLORS[2]),
]
