...
No Newton kernel or SDK source changes were made.
...
converged equilibria. This result does not mean that softer contacts generally slow Newton;
...
```powershell
python -B physx/tests/newton/pile/ComparePile.py --executable physx/compiler/newton/results/pile/official-mujoco-validation/bin/NewtonPileBenchmark.exe --impedance 0.9 0.95 --sizes 500 1000 --steps 201 --repeats 1 --threads 8 --snapshot-repeats 5 --output physx/compiler/newton/results/pile/softer-default-snapshots
python -B physx/tests/newton/pile/ComparePile.py --executable physx/compiler/newton/results/pile/official-mujoco-validation/bin/NewtonPileBenchmark.exe --impedance 0.99 0.99 --sizes 500 --steps 201 --repeats 1 --threads 8 --snapshot-repeats 5 --output physx/compiler/newton/results/pile/softer-intermediate-snapshots
```
...
`physx/compiler/newton/results/pile/softer-comparison-summary.json` joins both new comparisons
