...
| Current Newton | 2.0327 | 1.8853 | 3.1209 |
...
those inputs into retained Newton storage and writing the result back. Native timing covers
...
synchronous Newton preparation as this harness does. Common narrowphase/contact modification,
...
SwitchToThread waits. That aggregate wait activity is not Newton wall time and is not treated
...
physx/compiler/newton/experiments and are excluded from the maintained build.

The pre-pass backup is backups/Newton-full-pipeline-2026-09-14_17-09-09.zip,
...
physx/compiler/newton/results/optimization3/summary.json and final-live/.

Reproduce the full comparison from the repository root with
results/optimization3/ComparePipeline.py (paths are under physx/compiler/newton), using the
