...
// Solver and contact settings match the pallet scene, including PhysX Newton's default
...
int main(int argc, const char* const* argv)
{
	...
	if(argc < 3)
	{
		printf("MujocoCaseConveyor scene.xml output-prefix [steps=2000] [dt=.01] [iterations=100] [threads=8]\n"
	...
	for(int step = 0; step < steps; ++step)
	{
		...
		mujocoConveyor::applyConveyorVelocity(data, cases::conveyorCount, cases::beltSpeed);
