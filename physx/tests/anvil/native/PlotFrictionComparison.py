...
def main():
    ...
    variants = [('physical-pgs', 'PhysX PGS', '#228833', ':'),
                ('physical-anvil', 'PhysX-compatible Anvil', '#4477AA', '-'),
                ('associated-anvil', 'Convex native experiment', '#CC6677', '-'),
    ...
    figure.text(.5, .88, '1 kg box, rotation locked, friction 0.5. PGS and physical Anvil stay on the surface.', ha='center', fontsize=10)
