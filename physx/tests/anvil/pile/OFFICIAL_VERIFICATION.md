...
and 102,856 for 1,000 boxes. Timestep is 10 ms, versus MuJoCo's 2 ms default. Anvil, the
...
`physx/compiler/anvil/results/pile/official-mujoco-validation/bin`.
From the repository root:

```powershell
physx/compiler/anvil/results/pile/official-mujoco-validation/bin/AnvilPileBenchmark.exe physx/compiler/anvil/results/pile/shared-snapshots-8/pile500.xml physx/compiler/anvil/results/pile/official-mujoco-validation/500-official prototype 201 8 0 0 5
physx/compiler/anvil/results/pile/official-mujoco-validation/bin/AnvilPileBenchmark.exe physx/compiler/anvil/results/pile/shared-snapshots-8/pile1000.xml physx/compiler/anvil/results/pile/official-mujoco-validation/1000-official prototype 201 8 0 0 5
python -B physx/tests/anvil/pile/VerifyMujoco.py physx/compiler/anvil/results/pile/shared-snapshots-8/pile500.xml physx/compiler/anvil/results/pile/official-mujoco-validation/500-ordinary-step
```
